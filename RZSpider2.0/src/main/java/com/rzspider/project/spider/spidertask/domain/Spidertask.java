...
public class Spidertask extends BaseEntity {
	...
	public String toString() {
		return "Spidertask [taskId=" + taskId + ", taskName=" + taskName + ", spiderId=" + spiderId + ", spiderBackId="
				...
				+ ", taskExecfrequency=" + taskExecfrequency + ", taskParams=" + taskParams + ", cronExpression="
				+ cronExpression + ", times=" + times + ", taskExecfrequency2=" + taskExecfrequency2
				+ ", firstStartTime=" + firstStartTime + ", userId=" + userId + ", createBy=" + createBy
