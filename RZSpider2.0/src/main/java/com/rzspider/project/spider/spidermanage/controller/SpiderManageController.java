...
public class SpiderManageController extends BaseController {
	...
	@Log(title = "爬虫管理", action = "爬虫管理-新增爬虫")
	@GetMapping("/add")
	...
	@Log(title = "爬虫管理", action = "爬虫管理-保存爬虫")
	@PostMapping("/save")
	...
	@Log(title = "爬虫管理", action = "爬虫管理-修改爬虫")
	...
	@Log(title = "爬虫管理", action = "爬虫管理-删除爬虫")
	...
	@Log(title = "爬虫管理", action = "爬虫管理-批量删除爬虫")
