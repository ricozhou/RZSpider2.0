...
public class Customspider extends BaseEntity {
	...
	public String toString() {
		return "Customspider [customSpiderId=" + customSpiderId + ", customSpiderBackId=" + customSpiderBackId
				+ ", spiderJavaPackagePrefix=" + spiderJavaPackagePrefix + ", customSpiderType=" + customSpiderType
				+ ", spiderCodeTypeName=" + spiderCodeTypeName + ", spiderCodeTypeFolder=" + spiderCodeTypeFolder
				+ ", spiderDefaultParams=" + spiderDefaultParams + ", customStatus=" + customStatus + ", runStatus="
				+ runStatus + ", entryFileName=" + entryFileName + ", createBy=" + createBy + ", createTime="
