...
public class BaiDuOCRReadUtil {
	// 识别
	public static String recognizeText(String filePath, boolean isLocalImg) throws Exception {
		// 实例化baiduocr对象
		AipOcr client = new AipOcr(ThirdPartyCallConstant.THIRD_PARTY_CALL_BAIDU_OCR_APP_ID,
				ThirdPartyCallConstant.THIRD_PARTY_CALL_BAIDU_OCR_API_KEY,
				ThirdPartyCallConstant.THIRD_PARTY_CALL_BAIDU_OCR_SECRET_KEY);
		// 调用接口
