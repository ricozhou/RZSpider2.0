...
public class Blogcontent extends BaseEntity {
	...
	public String toString() {
		return "Blogcontent [cid=" + cid + ", title=" + title + ", slug=" + slug + ", created=" + created
				...
				+ ", categories=" + categories + ", hits=" + hits + ", commentsNum=" + commentsNum + ", likeNum="
				+ likeNum + ", allowComment=" + allowComment + ", allowPing=" + allowPing + ", allowFeed=" + allowFeed
				+ ", status=" + status + ", author=" + author + ", gtmCreate=" + gtmCreate + ", gtmModified="
				+ gtmModified + "]";
	}
